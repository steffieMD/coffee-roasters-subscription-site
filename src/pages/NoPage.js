...
const NoPage = () => {
  return (
    <div className="font-barlow text-center">
      <div className="flex items-center justify-center text-customdarkgrey">
        <span className="font-fraunces text-[150px] lg:text-[400px] md:text-[300px]">
          4
        </span>
        <svg
          className="w-[100px] h-[100px] md:w-[150px] md:h-[150px] lg:w-[250px] lg:h-[250px]"
          id="Layer_1"
          data-name="Layer 1"
      ...
      <p className="mb-10 text-customgrayishblue text-xl">
        uh oh! Nothing here....
      </p>
      <Link to="/">
